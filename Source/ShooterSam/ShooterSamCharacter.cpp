...
void AShooterSamCharacter::Move(const FInputActionValue& Value)
{
	...
	//UE_LOG(LogTemp, Display, TEXT("Current movement: %s, (X: %f, Y: %f)"), *MovementVector.ToString(), MovementVector.X, MovementVector.Y);
...
void AShooterSamCharacter::Look(const FInputActionValue& Value)
{
	...
	//UE_LOG(LogTemp, Display, TEXT("Current Look Vector: %s"), *LookAxisVector.ToString());
...
void AShooterSamCharacter::UpdateHUD()
{
	if (AShooterSamPlayerController* PlayerController = Cast<AShooterSamPlayerController>(GetController()))
	{
		...
		PlayerController->HUDWidget->SetHealthBarPercent(NewHealth);
	}
}
...
void AShooterSamCharacter::OnDamageTaken(AActor* DamagedActor, float Damage, const UDamageType* DamageType, AController* InstigatedBy, AActor* DamageCauser)
{
	if (IsAlive)
	{
		...
		UpdateHUD();
		//UE_LOG(LogTemp, Display, TEXT("Damage Taken: %f, Old Health: %f, New Health: %f"), Damage, OldHealth, CurrentHealth);
